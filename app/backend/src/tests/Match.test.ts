...
describe('Testes do endpoint /matches', () => {
  ...
  it('Response 200 e uma lista com todas as partidas', async () => {
    sinon.stub(MatchesModel, 'findAll').returns(matchesMock as any);
  ...
  it('Response 200 e uma lista com partidas em progresso', async () => {
    sinon.stub(MatchesModel, 'findAll').returns(matchesInProgress as any);
  ...
  it('Response 200 e uma lista com partidas que não estão em progresso', async () => {
    sinon.stub(MatchesModel, 'findAll').returns(matchesNotInProgress as any);
  ...
  it('Response 201 e mensagem de Finished! ao terminar uma partida em progresso', async () => {
    sinon.stub(jwt, 'verify').resolves(jwtMock);
